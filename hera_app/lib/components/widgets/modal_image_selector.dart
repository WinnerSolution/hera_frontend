...
//                 children: <Widget>[
//                   modalTitle ?? Text("Select:", style: Theme.of(context).textTheme.subtitle2),
//                   SizedBox(height: 5),
...
//                           child: Column(
//                             children: <Widget>[
//                               Icon(modalCameraIcon ?? Icons.camera, size: 40, color: Theme.of(context).primaryColor),
//                               modalCameraText ?? Text("camera", style: Theme.of(context).textTheme.overline)
//                             ],
//                           ),
//                         ),
//                         InkWell(
...
//                               modalGalleryText ?? Text("gallery", style: Theme.of(context).textTheme.overline)
//                             ],
//                           ),
//                         )
//                       ],
