...
class _$_TFollower extends _TFollower with DiagnosticableTreeMixin {
  _$_TFollower(
      {this.followerId, this.followingId, this.createdAt, this.updatedAt})
      : super._();
...
//
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TFollower(followerId: $followerId, followingId: $followingId, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
